...
from vibrant.models.state import OrchestratorState, OrchestratorStatus, ProviderRuntimeState
...
class OrchestratorEngine:
    ...
    @classmethod
    def load(cls, project_root: str | Path) -> OrchestratorEngine:
        ...
        engine = cls(root, state=state, agents=agents, consensus=consensus)
        engine._reconstruct_state()
        engine.persist_state()
        return engine

    @classmethod
    def create(cls, project_root: str | Path) -> OrchestratorEngine:
