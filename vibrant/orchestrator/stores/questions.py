...
from vibrant.orchestrator.types import QuestionPriority, QuestionRecord, QuestionStatus, utc_now
    ...
    def create(
        ...
        *,
        ...
        record = QuestionRecord(
            ...
            blocking_scope=_normalize_scope(blocking_scope),
        ...
        for question_id, payload in raw.items():
            ...
            try:
                records[question_id] = QuestionRecord(
                    ...
                    blocking_scope=_normalize_scope(payload.get("blocking_scope", "planning")),
...
def _normalize_scope(value: object) -> str:
    ...
    if normalized not in {"planning", "workflow", "task", "review"}:
        return "planning"
    return normalized
