...
- **Vibing**: monitor tasks, review consensus, optionally inspect agent logs, and keep chatting with the Gatekeeper
...
- `F8` show Agent Logs in vibing when enabled
- `F10` quit
...
- `/logs` open the Agent Logs tab when enabled
